...
**Story question:** *Will humanity receive creation as a gift and accept the limits of trust?*
...
- [Act 1: Formed from Dust](#act-1-formed-from-dust) — Gather the garden’s elements in creation order.
- [Act 2: The Garden](#act-2-the-garden) — Name creatures by matching them to habitats.
- [Act 3: Together](#act-3-together) — Build a shared shelter and tend one plot together.
- [Act 4: The Boundary](#act-4-the-boundary) — Navigate abundance while leaving one tree untouched.
- [Act 5: The Choice](#act-5-the-choice) — Spot the serpent’s half-truths in a dialogue puzzle.
- [Act 6: Hiding](#act-6-hiding) — Follow footprints and admit what happened.
- [Act 7: East of Eden](#act-7-east-of-eden) — Pack seeds and begin cultivation outside the garden.
- [Act 8: Cain and Abel](#act-8-cain-and-abel) — Prepare offerings with care, then cool Cain’s anger.
- [Act 9: The Field](#act-9-the-field) — Witness consequence and mark a refuge path.
- [Act 10: A New Line](#act-10-a-new-line) — Plant a family tree from Seth onward.
<!-- act-summary:end -->
...
<!-- consolidated-from: Adam/DESIGN.md -->
...
- **Approved Texture Forge inventory:** `leaves`, `grass`, `water_still`, `stone`, `wood_oak`, `fabric_weave`. Scene rows use only these keys; generated SVGs should preserve the key in filenames or metadata.
...
**Act summary:** Name creatures by matching them to habitats.
...
**Act summary:** Build a shared shelter and tend one plot together.
...
**Act summary:** Navigate abundance while leaving one tree untouched.
...
**Act summary:** Follow footprints and admit what happened.
...
**Act summary:** Pack seeds and begin cultivation outside the garden.
...
**Act summary:** Witness consequence and mark a refuge path.
...
**Act summary:** Plant a family tree from Seth onward.
