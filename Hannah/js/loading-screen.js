(function () {
  const themes = {
    Adam: { title: 'ADAM & EVE', icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" aria-hidden="true" focusable="false"><path fill="#ffd342" d="M32 6c1.5 10.5 5.5 14.5 16 16-10.5 1.5-14.5 5.5-16 16-1.5-10.5-5.5-14.5-16-16 10.5-1.5 14.5-5.5 16-16Z"/><path fill="#ff9d42" d="M48 35c.8 5.2 2.8 7.2 8 8-5.2.8-7.2 2.8-8 8-.8-5.2-2.8-7.2-8-8 5.2-.8 7.2-2.8 8-8Z"/><path fill="#fff3cf" d="M17 39c.6 3.4 1.8 4.6 5.2 5.2-3.4.6-4.6 1.8-5.2 5.2-.6-3.4-1.8-4.6-5.2-5.2 3.4-.6 4.6-1.8 5.2-5.2Z"/></svg>', color: '#4b9b72' },
    Daniel: { title: 'DANIEL', icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" aria-hidden="true" focusable="false"><circle cx="32" cy="32" r="24" fill="#d9772d"/><circle cx="20" cy="18" r="7" fill="#d9772d"/><circle cx="44" cy="18" r="7" fill="#d9772d"/><circle cx="32" cy="32" r="16" fill="#f6b84f"/><circle cx="25" cy="29" r="2" fill="#17131f"/><circle cx="39" cy="29" r="2" fill="#17131f"/><path fill="#17131f" d="M29 36h6l-3 4-3-4Z"/><path fill="none" stroke="#17131f" stroke-linecap="round" stroke-width="2" d="M32 40v3m0 0c-2 2-5 2-7 0m7 0c2 2 5 2 7 0"/><path fill="none" stroke="#b85f22" stroke-linecap="round" stroke-width="2" d="M15 32h7m20 0h7M17 40l6-2m24 2l-6-2"/></svg>', color: '#704b9f' },
  ...
  const theme = themes[folder] || { title: folder.toUpperCase(), icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" aria-hidden="true" focusable="false"><path fill="#ef463a" d="M32 14c-6-4-14-5-22-3v36c8-2 16-1 22 3 6-4 14-5 22-3V11c-8-2-16-1-22 3Z"/><path fill="#fff3cf" d="M14 15c6-1 12 0 16 3v31c-4-3-10-4-16-3V15Zm36 0c-6-1-12 0-16 3v31c4-3 10-4 16-3V15Z"/><path fill="none" stroke="#17131f" stroke-width="2" d="M32 14v36M10 11c8-2 16-1 22 3 6-4 14-5 22-3v36c-8-2-16-1-22 3-6-4-14-5-22-3V11Z"/></svg>', color: '#277b9b' };
