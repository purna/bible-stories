(function (global) {
  ...
  global.SCENE_FACTORIES.opening = function () {
    ...
    if (global.loadJSONScene) {
      var data = { version:1, name:'opening', settings:{background:'#0e1a22', fog:{color:'#0e1a22', density:0.004}}, camera:{distance:100, height:20}, objects:[
