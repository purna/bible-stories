(function (global) {
  ...
  global.SCENE_FACTORIES.horizon = function () {
    ...
    if (global.loadJSONScene) {
      var data = { version:1, name:'horizon', settings:{background:'#1a0e18', fog:{color:'#1a0e18', density:0.003}}, camera:{distance:110, height:18}, objects:[
